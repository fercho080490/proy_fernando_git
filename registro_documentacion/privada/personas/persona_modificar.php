...
$sql = $db->Prepare("SELECT * FROM personas WHERE id_persona = ? AND estado <> 'X'");
        ...
        echo "<div class='form-row'>
                <div class='form-column'>
                    <div class='form-group'>
                        ...
                        <input type='text' name='ci' id='ci' value='" . htmlspecialchars($fila["ci"]) . "'>
                        <span id='ciError' class='error'></span> <!-- Error message for CI -->
                    </div>
                    <div class='form-group'>
                        <label for='nombres'><b>(*)Nombres</b></label>
                        <input type='text' name='nombres' id='nombres' value='" . htmlspecialchars($fila["nombres"]) . "' onkeyup='this.value=this.value.toUpperCase()'>
                ...
                <div class='form-column'>
                    <div class='form-group'>
                        ...
                        <input type='text' name='ap' id='ap' value='" . htmlspecialchars($fila["ap"]) . "' onkeyup='this.value=this.value.toUpperCase()'>
                    </div>
                    <div class='form-group'>
                        <label for='am'><b>(*)Materno</b></label>
                        <input type='text' name='am' id='am' value='" . htmlspecialchars($fila["am"]) . "' onkeyup='this.value=this.value.toUpperCase()'>
            ...
            <div class='form-row'>
                <div class='form-column'>
                    <div class='form-group'>
                        ...
                        <input type='text' name='direccion' id='direccion' value='" . htmlspecialchars($fila["direccion"]) . "' onkeyup='this.value=this.value.toUpperCase()'>
                ...
                <div class='form-column'>
                    <div class='form-group'>
                        ...
                        <input type='text' name='telefono' id='telefono' value='" . htmlspecialchars($fila["telefono"]) . "'>
                        <span id='telefonoError' class='error'></span> <!-- Error message for Telefono -->
                    </div>
                </div>
            </div>
            <div class='form-buttons'>  
                <input type='button' name='modificar' class='boton' value='MODIFICAR PERSONA' onclick='validar();'> <!-- Change to type='button' -->
                <input type='hidden' name='id_persona' value='" . htmlspecialchars($fila["id_persona"]) . "'>
